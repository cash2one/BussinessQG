...
punish_string = 'insert into gs_punish(gs_basic_id,number, types, content,date, pub_date, gov_dept,updated)values(%s,%s,%s,%s,%s,%s,%s,%s)'
    ...
    for key in information.keys():
        ...
        try:
            ...
            if count == 0:
                ...
                gs_basic_id, number, types, content, date, pub_date, gov_dept, updated_time))
