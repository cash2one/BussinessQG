...
select_string = 'select gs_shareholder_id from gs_shareholder where gs_basic_id = %s and name = %s and reg_amount = %s and true_amount = %s, cate = %s'
...
def name(data):
    ...
    for i in xrange(len(data)):
        ...
        ta_ways = aubDetails["acConFormNam"]
