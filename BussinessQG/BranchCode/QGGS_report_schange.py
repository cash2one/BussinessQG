...
update_schange = 'update gs_report_schange set percent_pre = %s ,percent_after = %s,dates = %s,uuid= %s,updated = %s where gs_report_schange_id = %s'
        ...
        try:
            ...
            if count == 0:
                ...
                flag = cursor.execute(update_schange,
                                      (percent_pre, percent_after, dates,uuid, updated_time, gs_report_schange_id))
                connect.commit()
                update_flag += flag
        except Exception, e:
