...
def get_year_list(data,province):
    ...
    return info
def update_all_info(gs_search_id,gs_basic_id,url):
    ...
    App_basic.main(gs_search_id, gs_basic_id, basicinfo)
    App_branch.main(gs_search_id, gs_basic_id, branchinfo)
    App_black.main(gs_search_id, gs_basic_id, blackinfo)
    App_brand.main(gs_search_id, gs_basic_id, brandinfo)
    App_change.main(gs_search_id, gs_basic_id, changeinfo)
    App_check.main(gs_search_id, gs_basic_id, checkinfo)
    App_clear.main(gs_search_id, gs_basic_id, clearinfo)
    App_except.main(gs_search_id, gs_basic_id, exceptinfo)
    App_freeze.main(gs_search_id, gs_basic_id, freezeinfo, province)
    App_mort.main(gs_search_id, gs_basic_id, mortinfo, province)

    App_permit.main(gs_search_id, gs_basic_id, permitinfo)
    App_permit2.main(gs_search_id, gs_basic_id, permitinfo2)
    App_person.main(gs_search_id, gs_basic_id, personinfo)
    App_punish.main(gs_search_id, gs_basic_id, punishinfo)
    App_punish2.main(gs_search_id, gs_basic_id, punishinfo2)
    App_shareholder.main(gs_search_id, gs_basic_id, sharehinfo)
    App_stock.main(gs_search_id, gs_basic_id, stockinfo)
    ...
    # App_report.main(gs_search_id,gs_basic_id,reportinfo,province)

if __name__ == "__main__":
    # print "The Program start time:", time.strftime("%Y-%m-%d %H:%M:%S", time.localtime())
    # start = time.time()
    update_all_info(gs_search_id,gs_basic_id,url)
