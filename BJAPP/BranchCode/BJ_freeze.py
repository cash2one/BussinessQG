...
class Freeze:
	def name(self,url):
		...
		if status_code == 200:
			...
			info[0] = [court,executor,rule_no,items,start_date,end_date,pub_date,stock,cert_cate,cert_code,end_freeze]
		else:
			flag = 100000004
		# print info,flag
		return info,flag
	...
	def update_to_db(self, information,gs_basic_id):
		...
		try:
			...
			for key in information.keys():
				court, executor, rule_no, items = information[key][0],information[key][1],information[key][2],information[key][3]
				start_date, end_date, pub_date, stock_amount = information[key][4],information[key][5],information[key][6],information[key][7]
