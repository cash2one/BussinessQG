...
url = 'http://qyxy.baic.gov.cn/wapqyzb/wapqyzbAction!wapbsnd.dhtml?entId=1F613E205C1C4C71A87CAFB83E6CE993'
				...
				if flag ==1:
					...
					if remark ==1:
						if "share" in branch_list.keys():
							...
							# print flag
							if flag == 1:
								remark, total, insert_flag, update_flag = BJ_report_share.update_to_db(gs_report_id, gs_basic_id, cursor, connect, info, province)
						...
						if "invest" in branch_list.keys():
							...
							if flag ==1:
								remark, total, insert_flag, update_flag = BJ_report_invest.update_to_db(gs_report_id,gs_basic_id, cursor,connect, info, province)
						...
						if "web" in branch_list.keys():
							...
							info,flag = BJ_report_web.main(web_url)
							if flag == 1:
