		...
		try:
			...
			for key in info.keys():
				...
				if int(count) == 1:
					...
					rows_count = cursor.execute(insert_string, (gs_shareholder_id,gs_basic_id,name,types,reg_amount,ra_ways,ra_date,true_amount,ta_ways,ta_date,updated_time,gs_shareholder_id))
